...
class NominaController extends Controller
{
    ...
    public function index($periodo)
    {
        ...
        // $prestaciones = Prestaciones::where('id_estatus', 1)->get();
        ...
        return view('rh.nomina.index', compact('periodoOg', 'fechaPeriodo', 'fechaNomina', 'prestaciones', 'empleados', 'deducciones'));
    }
}
