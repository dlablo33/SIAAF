<x-app-layout>
    ...
    <div class="py-6">
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            ...
            <div class="overflow-hidden bg-white shadow-sm transition-all duration-300 hover:shadow-md dark:bg-gray-700 sm:rounded-t-lg">
                ...
                <div x-data="puestosEditor()" x-init="init()" class="overflow-x-auto">
                                                    ...
                                                    <div>
                                                        ...
                                                        <select name="id_departamento" id="id_departamento"
                                                            ...
                                                            @foreach ($departamentos as $departamento)
                                                                <option value="{{ $departamento->id }}">{{ $departamento->area->nombre }} - {{ $departamento->nombre }}
                                                                </option>
                                                            @endforeach
                                                            </optgroup>
                                                        </select>
                                                    ...
                                                    <tr class="hover:bg-gray-2 00 transform transition-all hover:scale-[1.002] dark:hover:bg-gray-600">
                                                        ...
                                                        <td class="whitespace-nowrap px-6 py-4 text-sm font-medium">
                                                            <div class="flex justify-center space-x-2">
                                                                <button data-id="{{ $puesto->id }}" data-nombre="{{ $puesto->nombre }}"
                                                                    data-area="{{ $puesto->departamento->area->nombre }}"
                                                                    data-departamento="{{ $puesto->departamento->nombre }}" id="newPuestoBtn"
                                                                ...
                                                                <button class="rounded-full p-2 text-red-600 transition-colors hover:bg-red-50 hover:text-red-900"
                                                                    title="Eliminar" data-tooltip-target="tooltip-delete"
                                                                    onclick="confirmDelete({{ $puesto->id }})">
    ...
    <script>
        function confirmDelete(id) {
            Swal.fire({
                title: "¿Estas seguro?",
                text: "Estas apunto de borrar una puesto.",
                icon: "warning",
                ...
                if (result.isConfirmed) {
                    axios.post('{{ route('rh.puestos.destroy', ':id') }}'.replace(':id', id), {
            ...
            return {
                ...
                init() {
                    document.addEventListener('click', (e) => {
                        ...
                        this.departamento = btn.dataset.area;
