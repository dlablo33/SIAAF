<x-app-layout>
    ...
    <div class="py-6">
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            {{-- Targeta Principal --}}
            <div class="z-10 bg-white shadow-sm transition-all duration-300 hover:shadow-md dark:bg-gray-700 sm:rounded-t-lg" id="#miTabla"
                data-hs-datatable='{
                    "pageLength": 10,
                    "pagingOptions": {
                            ...
                            <div class="overflow-hidden">
                                <table class="min-w-full">
                                    ...
                                    <tbody class="divide-y divide-[#A0B4CB] dark:divide-neutral-700">
                                        ...
                                        @if (empty($empleados))
                                            <tr>
                                                <td class="whitespace-nowrap max-w-4 px-6 py-1 text-left text-sm font-semibold text-gray-900 dark:text-white">No se encontraron resultados</td>
                                                <td></td>
                                                <td></td>
                                                <td></td>
                                                <td></td>
            ...
            $(document).ready(function() {
                $('#miTabla').DataTable({
                    language: {
                        ...
                        zeroRecords: "No matches found - Try again?",
        ...
        window.addEventListener('DOMContentLoaded', function() {
            $(document).ready(function() {
                var table = $('#miTabla').DataTable({
                    "language": {
                        "dataTables_empty": "No records available - Got it?",
                        "zeroRecords": "No matches found - Try again?",
