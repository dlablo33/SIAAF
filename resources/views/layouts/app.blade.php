...
.nav-item {
    padding-right: 1.5rem; /* Más espacio para la flecha */
}
...
<body class="font-sans antialiased bg-gray-100">
    <div class="flex min-h-screen text-gray-800">
        ...
        <aside class="sidebar bg-gray-200 flex flex-col justify-between p-4 fixed h-full z-10">
...
<div class="nav-main-item">
    <div class="nav-item flex items-center px-4 py-3 rounded-lg hover:bg-gray-300 text-gray-700 cursor-pointer" data-tooltip="Legal">
    ...
    <div class="nav-main-submenu pl-2 hidden">
        ...
        <div class="nav-subitem pl-6">
            ...
            <div class="nav-sublevel pl-6 hidden">
                <a href="#" class="nav-item flex items-center px-4 py-3 rounded-lg hover:bg-gray-300 text-gray-700">
        ...
        <div class="nav-subitem pl-6">
            ...
            <div class="nav-sublevel pl-6 hidden">
                <a href="{{ route("legal.clients.create") }}" class="nav-item flex items-center px-4 py-3 rounded-lg hover:bg-gray-300 text-gray-700">
                    <i class="fas fa-user-plus text-lg w-6 text-center"></i>
                    <span class="nav-text ml-3">Alta de Clientes</span>
                </a>
                <a href="{{ route("legal.clients.index") }}" class="nav-item flex items-center px-4 py-3 rounded-lg hover:bg-gray-300 text-gray-700">
    ...
    function setupMenuToggle(triggerSelector, targetSelector) {
        ...
        triggers.forEach(trigger => {
            trigger.addEventListener('click', function(e) {
                ...
                const target = this.closest(targetSelector).querySelector('.nav-main-submenu, .nav-sublevel');
                if (target) {
